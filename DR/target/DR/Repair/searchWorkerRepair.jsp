...
.grey{ color:grey }
  ...
  <body>
    ...
    <s:text name="Query the maintenance record of the designated repairman"></s:text>
    <center><s:form name="searchWorkerRepair" action="searchWorkerRepairJsp" namespace="/" method="post">
    <s:textfield key="serchWorkerRepair" name="workerid"></s:textfield><s:submit key="true.submit"></s:submit>
    </s:form></center>
    <table border="2" cellspacing="0" align="center">
    	<tr align="center">
    		<td><s:text name="number"></s:text></td>
    		<td><s:text name="building"></s:text></td>
    		<td><s:text name="floor"></s:text></td>
    		<td><s:text name="room"></s:text></td>
