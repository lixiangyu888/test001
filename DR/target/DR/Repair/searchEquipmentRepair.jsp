...
.grey{ color:grey }
  ...
  <body>
    ...
    <s:text name="Find the maintenance record of the specified equipment"></s:text>
    <center><s:form name="searchEquipmentRepair" action="searchEquipmentRepairJsp" namespace="/" method="post">
    ...
    <table border="2" cellspacing="0" align="center">
    	<tr align="center">
    		...
    		<td><s:text name="repairid"></s:text></td>
